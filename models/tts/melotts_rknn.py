...
def get_args():
    ...
    parser.add_argument("--wav", "-w", type=str, required=False, default=os.path.join(base_dir,"output.wav"))
    parser.add_argument("--encoder", "-e", type=str, required=False, default=os.path.join(base_dir,"encoder.onnx"))
    parser.add_argument("--decoder", "-d", type=str, required=False, default=os.path.join(base_dir,"decoder.rknn"))
    ...
    parser.add_argument("--lexicon", type=str, required=False, default=os.path.join(base_dir,"lexicon.txt"))
    parser.add_argument("--token", type=str, required=False, default=os.path.join(base_dir,"tokens.txt"))
...
def main():
    ...
    lexicon_filename = os.path.join(base_dir, "lexicon.txt")
    token_filename = os.path.join(base_dir, "tokens.txt")
    # Load lexicon
    ...
    # Load static input
    base_dir = os.path.dirname(os.path.abspath(__file__))
    g_path = os.path.join(base_dir, "g.bin")
    g = np.fromfile(g_path, dtype=np.float32).reshape(1, 256, 1)
